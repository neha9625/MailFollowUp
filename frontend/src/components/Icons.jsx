/**
 * Tiny inline SVG icon set (stroke style) — no external icon dependency.
...
const paths = {
  ...
  unlink: (
    <>
      <path d="M18.84 12.25 20.5 10.5a4.95 4.95 0 1 0-7-7l-1.75 1.66" />
      <path d="M5.16 11.75 3.5 13.5a4.95 4.95 0 1 0 7 7l1.75-1.66" />
      <path d="M4 4l16 16" />
    </>
  ),
  mailCheck: (
...
/** Google "G" logo (multi-color, official shapes). */
